...
import PaginationSelection from "@/pages/category/components/PaginationSelection";
...
export function CategoryTable<TData, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
