  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button id="add-brand-button" className="h-10 w-full sm:w-auto">
          Ajouter une Marque
        </Button>
      </DialogTrigger>
      <DialogContent className="w-[95vw] max-w-[800px] max-h-[95vh] overflow-y-auto p-4 sm:p-6 sm:max-w-[800px] md:p-7 md:px-8 poppins" onInteractOutside={e => e.preventDefault()}>
        <DialogHeader className="space-y-2">
          ...
          <DialogDescription className="text-sm sm:text-base text-center sm:text-left">
            Remplissez le formulaire pour ajouter une nouvelle marque
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="flex flex-col gap-4">
            <div className="space-y-1">
              ...
              <Input
                id="brand_name"
                type="text"
                placeholder="Entrez le nom de la marque (min. 2 caractères)"
